...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🎉 Welcome to the NOOB AM Ultimate UDP Flooder! 🎉*\n\n"
...
async def attack(update: Update, context: CallbackContext):
    ...
    if user["coins"] < COINS_REQUIRED_PER_ATTACK:
        await context.bot.send_message(
            chat_id=chat_id,
            text="*💰 Insufficient coins! Please contact the admin to acquire more coins. DM: @NOOB_AM*",
            parse_mode='Markdown'
        )
        return
...
async def help(update: Update, context: CallbackContext):
    chat_id = update.effective_chat.id
    message = (
        "*🛠️ NOOB AM VIP DDOS Bot Help Menu 🛠️*\n\n"
        ...
        "- *If you encounter any issues, contact the admin: @NOOB_AM*\n\n"
